...
public class SqsService {
    ...
    public void sendMsg() {
        ...
        // Removed PurgeQueue call to avoid AWS API throttling
        // PurgeQueue is not necessary for message sending functionality
        // and causes 403 errors due to 60-second rate limit
    }
