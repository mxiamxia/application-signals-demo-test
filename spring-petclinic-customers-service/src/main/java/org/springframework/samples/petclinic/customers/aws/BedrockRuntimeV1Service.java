...
import com.amazonaws.services.bedrockruntime.model.ThrottlingException;
    ...
    public String invokeTitanModel(String petType) {
        ...
        while (attempt < MAX_RETRIES) {
            try {
                ...
                log.error("Invoke titan Model Result: Error: {}", e.getMessage());
                throw e;
            }
        }
        throw new RuntimeException("Failed to invoke Titan model after " + MAX_RETRIES + " attempts", lastException);
    }
}
